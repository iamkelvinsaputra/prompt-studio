...
/** Local vector placeholders. Replace the drawing here without changing character state or controls. */
@Composable
...
internal fun DrawScope.drawSilhouette(state: VisualAssemblyState, aspectRatio: String?, thumbnail: Boolean) {
    ...
    val inset = if (thumbnail) 4f else 12f
